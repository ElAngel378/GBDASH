...
const void __at(200) __bank_song_template;
const hUGESong_t song_template = {6, &order_cnt, order1, order2, order3,order4, duty_instruments, wave_instruments, noise_instruments, NULL, waves};
